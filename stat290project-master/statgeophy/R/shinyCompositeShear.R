#' Run the shiny app for compositeShear modelling
#' @description Runs a shiny app compositeShear modelling with
...
##
shinyCompositeShear <- function() {
  app_dir <- system.file("shinyPlots", "compositeShear", package = 'statgeophy');
  if (app_dir == "") {
